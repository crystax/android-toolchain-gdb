...
/* ANDROID CHANGE BEGIN 1 */
#include "main.h"
#include <sys/param.h>
#if defined(__APPLE__)
#include <libproc.h>
#endif
/* ANDROID CHANGE END 1 */
                                           ...
                                           char** pythonhome)
{
  ...
  const char* gdb_program_name = get_gdb_program_name();
